...
//Modified Targaryens to fit the class
...
public class ControlPanel extends JPanel {
    private JButton stark, baratheon, lannister, tully, targaryen, customHouse;
    ...
    public ControlPanel() {
        ...
        targaryen.addActionListener(new ButtonListener("Targaryen"));
        add(targaryen);
        ...
        customHouse = new JButton("Schauer");
        customHouse.addActionListener(new ButtonListener("Schauer"));
        add(customHouse);
